...
struct VotingOverviewView: View {
    ...
    var body: some View {
        ...
        .sheet(item: $selectedActivityForVoting) { activity in
            NavigationStack {
                VoteActivityView(activity: activity, onSave: { updatedActivity in
        ...
        .sheet(item: $selectedActivityForResult) { activity in
            NavigationStack {
                ActivityResultView(activity: activity, accentColor: accentColor)
            }
        }
    }
}
        ...
        VStack(spacing: 32) {
            ...
            Button(action: {
                ...
                Text("Abstimmen")
                    ...
                    .padding()
                    .background(myRating > 0 ? accentColor : Color.gray)
